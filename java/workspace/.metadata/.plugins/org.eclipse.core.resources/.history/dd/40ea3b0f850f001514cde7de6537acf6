...
public class Aty_listview_ext extends Activity implements OnItemClickListener {
...
//		lv.setAdapter(new ListView_ext_adapter(Aty_listview_ext.this));
		adapter = new ListView_ext_adapter(Aty_listview_ext.this);
...
//		lv.setOnItemClickListener(doHandleClick());
	...
	public void onItemClick(AdapterView<?> parent, View view, int position,
		...
		Toast.makeText(Aty_listview_ext.this, celldata.getName()+" "+celldata.getDescription(), Toast.LENGTH_SHORT).show();
