...
public class AccessPoint extends Preference {
	private static SWLogger log = SWLogger.getLogger(AccessPoint.class);
	...
	public String getSecurityString(boolean concise) {
		...
		default:
			return concise ? context.getString(R.string.wifi_security_none)
					: context.getString(R.string.wifi_security_none);
		}
	}
	...
	public void update(int networkId, int reason) {
		...
		if (networkId != WifiConfiguration.INVALID_NETWORK_ID
			...
			log.d("ssid=" + ssid + " config=" + mConfig);
			if (mConfig != null) {
	...
	public void update(AccessPoint ap) {
		if (ap.getSsid().equals(ssid)) {
			if (bssid == null || ap.getBssid() == null
					|| bssid.equals(ap.getBssid())) {
			...
			if (!TextUtils.isEmpty(ssid)) {
				ToastHelper
						.showMessage(
								...
								ssid
										+ mContext
												.getString(R.string.network_wifi_failed),
	...
	private String get(Context context, String ssid, DetailedState state) {
		...
		// log.d("ssid=" + this.ssid + ",state=" + state);
